...
# Compute MSE/RMSE
mse_1 <- mean((forecast_1$mean - test_data)^2)
mse_2 <- mean((forecast_2$mean - test_data)^2)
...
forecast_10_1 <- forecast(model_1, h=10)
forecast_10_2 <- forecast(model_2, h=10)
...
forecast_10 <- forecast(var_model, h=10)
